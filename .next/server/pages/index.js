...
})(["display:flex;flex-direction:column;align-items:center;justify-content:space-between;grid-column-start:7;grid-column-end:10;grid-row-start:5;grid-row-end:7;outline:20px solid ", ";background-color:", ";z-index:10;@media (max-width:855px){grid-column-end:11;}@media (max-width:700px){grid-column-start:1;grid-column-end:2;grid-row-start:2;grid-row-end:3;}"], colors/* colorLightGrey */.Nt, colors/* colorLightGrey */.Nt);
...
})(["grid-column-start:10;grid-column-end:13;grid-row-start:1;grid-row-end:7;z-index:5;outline:20px solid ", ";@media (max-width:855px){grid-row-end:5;}"], colors/* colorLightGrey */.Nt);
...
})(["grid-column-start:7;grid-column-end:11;grid-row-start:7;grid-row-end:end;"]);
